...
<li class='field_block' id='field_1_div'><div class='col_label'>
    ...
    <div class='col_field'>
    <input type="text" name="field_1"  id="field_1" value="<?php  phpfmg_hsc("field_1", ""); ?>" class='text_box' placeholder="Please enter your full name">
<!--     <div id='field_1_tip' class='instruction'>Please enter your name</div> -->
    </div>
</li>
...
<li class='field_block' id='field_0_div'><div class='col_label'>
	...
	<div class='col_field'>
	<input type="text" name="field_0"  id="field_0" value="<?php  phpfmg_hsc("field_0", ""); ?>" class='text_box' placeholder="Please enter your email">
<!-- 	<div id='field_0_tip' class='instruction'>Please enter your email</div> -->
	</div>
</li>
...
<li class='field_block' id='field_2_div'><div class='col_label'>
	...
	<div class='col_field'>
	<textarea name="field_2" id="field_2" rows=4 cols=25 class='text_area'><?php  phpfmg_hsc("field_2"); ?>Place your message here...</textarea>

<!-- 	<div id='field_2_tip' class='instruction'>Place your message here...</div> -->
	</div>
</li>
